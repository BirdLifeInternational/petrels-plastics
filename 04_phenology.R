...
## TO SAVE RESULTS
#dir.create(paste0(dir,"/scripts_results/05_phenology/")) #added - BC
dir_phen <- paste0(dir,"/scripts_results/05_phenology") #changed - BC
...
write.csv(pops,paste0(dir,"/scripts_results/05_phenology/pops.csv"),
          row.names = F)
